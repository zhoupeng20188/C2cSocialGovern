package com.zp.reviewer.config.druid;
...
@MapperScan(basePackages = MyDruidConfig.PACKAGE, sqlSessionFactoryRef = "sessionFactory")
public class MyDruidConfig implements DbConfig {


    public static final String PACKAGE = "com.zp.**.mapper";
